    ...
    def get_batch_all_models(self, 
        ...
        for data in list_of_data:
            ...
            if internal_choice == 'global':
                x, y, internal_features = make_x_y_with_stored_data_global(train_test_in=inliners, test_la=la, weight_variable=model_name)
        ...
        return Batch(x=xs.transpose(0, 1), y=None, internal_xs= internal_xs.transpose(0,1), target_y=ys.transpose(0, 1),model_names = model_names, single_eval_pos=single_eval_pos)