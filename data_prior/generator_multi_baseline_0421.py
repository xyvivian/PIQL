...
class PriorTrainDataGenerator:  # generate synthetic data for training
    ...
    def get_batch_all_models(self, 
        ...
        def make_x_y_with_stored_data_global(train_test_in, test_la, weight_variable=None):
            ...
            return x, y, 0 #internal_features.shape[0]
        ...
        return Batch(x=xs.transpose(0, 1), y=None, internal_xs=internal_xs, target_y=ys.transpose(0, 1),model_names = model_names, single_eval_pos=single_eval_pos) #+prepend_dim)