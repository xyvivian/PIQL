...
from data_prior.generator_performer import PriorTrainDataGenerator
from model_meta_0413 import encoders
from trainer.trainer_performer_0413_deeper import ZeroShotOD
...
def main(cfg: DictConfig) -> None:
    ...
    config_details = f'meta_performer_0413_context{seq_len}.feat{max_feature_dim}.R{num_R}.LT{apply_linear_transform}.gen1tr1{gen_one_train_one}.reuse{reuse_data_every_n}.E{epochs}.step{steps_per_epoch}.bs{batch_size}.lr{lr}.emb{emsize}.hdim{nhid}.nhead{nhead}.nlayer{nlayer}.ndevice{num_device}.T0{T0}_{current_time}'
    ...
    trainer.fit(zero_shot_od_pl_model) #,ckpt_path = '/ocean/projects/cis250290p/xding/FoMo-Meta_0413/ckpt/meta_performer_0413_context5000.feat100.R500.LTFalse.gen1tr1True.reuse100.E1500.step1000.bs2.lr0.0001.emb256.hdim512.nhead4.nlayer2.ndevice4.T00_20260414/seed0/min-trainloss-epoch=87-train_loss=0.02.ckpt')
...
#CUDA_VISIBLE_DEVICES=5,1,3,0 python pretrain_performer.py train.apply_linear_transform=False train.gen_one_train_one=True  train.seed=0 train.num_R=500 train.epochs=1500