    ...
    for ckpt, filename in ckpt_infos:
        ...
        for dataset_list in [datagenerator.dataset_list_gmm]:
            ...
            for dataset in dataset_list:
                ...
                save_path = f'results/gaussian_in/2layer_piql/{model_name}/{dataset}'
                print(save_path)
...
#CUDA_VISIBLE_DEVICES=1 python eval_gmm_piql_gaussian_in.py train.apply_linear_transform=False train.gen_one_train_one=True prior.mixture.max_feature_dim=100 prior.mixture.max_model_dim=100 train.seed=0 train.num_R=500 test.seed=0 test.preprocess_transform=null
