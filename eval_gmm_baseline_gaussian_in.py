...
def main(cfg: DictConfig):
    ...
    model_path = '/home/xding2/PIQL/pretrained_ckpts/2layer_baseline'
    ...
    for ckpt, filename in ckpt_infos:
        ...
        for dataset_list in [datagenerator.dataset_list_gmm]:
            ...
            for dataset in dataset_list:
                ...
                model_name = f'baseline_{ckpt}'  # 'fomo'  #'fomoorigin2'  #'gmm'  #'fomoorigin2' #'fomo'
                save_path = f'results/gaussian_in/2layer_baseline/{model_name}/{dataset}'
                print(save_path)
