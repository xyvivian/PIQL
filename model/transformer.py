...
class TransformerModel(nn.Module):
    ...
    * Optional global attention tokens: prepended learnable embeddings that
    ...
    def __init__(self, encoder, ninp: int, nhead: int, nhid: int, nlayers: int,
                 dropout: float = 0.0, style_encoder=None, y_encoder=None,
    ...
    def forward(self, *args, **kwargs):
        ...
        if len(args) == 3:
            ...
            allowed = {'src_mask', 'single_eval_pos', 'only_return_standard_out'}
            assert set(kwargs) <= allowed, \
                f"Unexpected kwargs: {set(kwargs) - allowed}"
    ...
    def _forward(self, src, src_mask=None, single_eval_pos=None,
        ...
        out_start = num_prefix if self.return_all_outputs else single_eval_pos + num_prefix
        out_end = (
