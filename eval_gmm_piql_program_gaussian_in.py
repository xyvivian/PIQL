...
from trainer.trainer_performer_program_encoder_0427 import make_model_od
...
def main(cfg: DictConfig):
    ...
    model_path = '/home/xding2/PIQL/pretrained_ckpts/2layer_piql_program'
    ...
    for ckpt, filename in ckpt_infos:
        ...
        for dataset_list in [datagenerator.dataset_list_gmm]:
            ...
            for dataset in dataset_list:
                ...
                save_path = f'results/gaussian_in/2layer_piql_program/{model_name}/{dataset}'
                print(save_path)
