...
from model_meta_0413.transformer_program_encoder_performer import TransformerModel
...
def load_program_encoder_weights(model: LitGMMMetricLearner, ckpt_path: str) -> None:
...
class ZeroShotOD(pl.LightningModule):
    def __init__(self, 
        ...
        self.program_encoder_ckpt = getattr(
            ...
            '/ocean/projects/cis250290p/xding/FoMo-Meta_0413/trainer_embedder/ckpt/gmm_triplet/gmm_triplet.d2-100.k1-5.cls1.E100.step50.bs16.lr0.0001.nneg8.20260426_115259/seed42/min-trainloss-epoch=36-step=001850.ckpt',
        )
        self.program_encoder_dim = int(getattr(train_cfg, 'program_encoder_dim', 27))
        ...
        self.program_encoder_max_tokens = getattr(train_cfg, 'program_encoder_max_tokens', None)
        ...
        self.program_encoder_margin = float(getattr(train_cfg, 'program_encoder_margin', 1.0))
        self.program_encoder_warmup_ratio = float(getattr(train_cfg, 'program_encoder_warmup_ratio', 0.1))
        self.program_encoder_min_lr_ratio = float(getattr(train_cfg, 'program_encoder_min_lr_ratio', 0.0))
    ...
    def _build_program_encoder_module(self):
        program_encoder = build_program_encoder_model(
            ...
            margin=self.program_encoder_margin,
    ...
    def forward(self, full_data):
        ...
        internal_embeds = internal_embeds.reshape(internal_embeds.shape[0], 10, 256)[:,0,:]
