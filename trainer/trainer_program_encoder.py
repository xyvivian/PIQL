...
from model_meta_0413.transformer_program_encoder import TransformerModel
...
class ZeroShotOD(pl.LightningModule):
    def __init__(self, 
        ...
        self.program_encoder_ckpt = getattr(
            ...
            '/ocean/projects/cis250290p/xding/FoMo-Meta_0413/trainer_embedder/ckpt/gmm_triplet/gmm_triplet.d27.k3.cls10.E100.step50.bs16.lr0.001.nneg8.20260420_000803/seed42/min-trainloss-epoch=08-step=000450.ckpt',
        )
