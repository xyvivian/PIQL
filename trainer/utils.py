...
def get_cosine_schedule_with_warmup_min_lr(optimizer, num_warmup_steps, num_training_steps, num_cycles=0.5, min_lr_ratio=0.1, last_epoch=-1):
    """ Create a schedule with a learning rate that decreases following the
    values of the cosine function between min_lr_ratio and 1.0 after a warmup
    period during which it increases linearly between 0 and 1.
    The learning rate will not decay below min_lr_ratio (default 10%) of peak lr.
    """
    ...
    def lr_lambda(current_step):
        ...
        # Scale cosine decay to be between min_lr_ratio and 1.0 instead of 0.0 and 1.0
